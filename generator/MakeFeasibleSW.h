#ifndef MAKE_FEASIBLE_SW_H
#define MAKE_FEASIBLE_SW_H
...
void MakeFeasibleSW(std::vector<Station> &stations) 
{
	...
	for (size_t i = 0; i < stations.size(); i++) 
	{
		...
		if(s.uElectric<0) s.uElectric = 0;
	...
	printf("Modified tgt:%d cap:%d diffCap:%d deleted:%d out of %d total stations, in MakeFeasibleSW!\n",
