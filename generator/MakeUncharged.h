#ifndef MAKE_UNCHARGED_H
#define MAKE_UNCHARGED_H
...
void MakeUncharged(std::vector<Station> & stations, double uncharged_percentage, RandomNumbers & rn)
{
    int sum_electric = 0;
    int sum_uelectric = 0;
    ...
    if (sum_electric == 0) 
	{
		printf("No electric bike. Phil Collins (1989), exiting ...\n"); exit(1);
	}
	...
	printf("Final sum of uElectric:%d initElectric:%d u/e:%.3lf\n",
